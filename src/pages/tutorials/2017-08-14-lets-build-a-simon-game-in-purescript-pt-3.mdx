...
To summarize, in the last [post](2017-08-14-lets-build-a-simon-game-in-purescript-pt-2) you learned how to: create HTML markup using the smolder library, render markup to the DOM, and a whole bunch of operators (`<$>, <#>, $, =<<, <@>`) 🙀.
