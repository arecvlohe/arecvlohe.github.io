...
To get start👇ed locally check out the article you can either use a setup using [webpack and bs-platform](2018-09-28-getting-started-with-reasonreact) or the `github` link above. After getting that up and running you should be ready for the next phase.
